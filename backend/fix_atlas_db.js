...
// NOTE: Ensure your .env file has the correct MONGO_URI for your ATLAS database
...
const fixIndexesAndResetCounters = async () => {
    ...
    try {
        console.log("--- STARTING ATLAS/DB CLEANUP ---");
        const collection = mongoose.connection.collection('students');
        
        console.log('Step 1: Dropping all indexes on students collection...');
        try {
        ...
        console.log('Step 2: Cleaning up empty sparse fields...');
        ...
        console.log('Step 3: Resetting ALL counters (Registration & Enrollment sequences)...');
        try {
