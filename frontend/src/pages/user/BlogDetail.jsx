...
import { 
    ...
    MessageCircle, MessageSquare, TrendingUp, Tag, ArrowRight, Send, Trash2, Shield
} from 'lucide-react';
                            ...
                            <div className="flex flex-wrap items-center justify-center gap-6 text-sm md:text-base text-gray-200">
                                ...
                                <div className="relative">
                                    <button
                                        ...
                                        className="flex items-center gap-2 bg-white/20 hover:bg-white/30 backdrop-blur-sm px-4 py-2 rounded-full font-bold transition-all border border-white/30"
                                    >
                                    ...
                                    <AnimatePresence>
                                        {showShareMenu && (
                                            <motion.div
                                                ...
                                                className="absolute top-full mt-2 left-1/2 -translate-x-1/2 bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden z-50 w-48"
                                            >
                                                <button onClick={() => handleShare('whatsapp')} className="flex items-center gap-3 w-full px-4 py-3 text-sm font-bold text-gray-700 hover:bg-green-50 hover:text-green-600 transition-colors">
                                                ...
                                                <button onClick={() => handleShare('facebook')} className="flex items-center gap-3 w-full px-4 py-3 text-sm font-bold text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors">
                                                ...
                                                <button onClick={() => handleShare('twitter')} className="flex items-center gap-3 w-full px-4 py-3 text-sm font-bold text-gray-700 hover:bg-sky-50 hover:text-sky-500 transition-colors">
                                                    <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current text-sky-500"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.737-8.835L1.254 2.25H8.08l4.253 5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                                                    X (Twitter)
                                                </button>
                                                <button onClick={() => handleShare('copy')} className="flex items-center gap-3 w-full px-4 py-3 text-sm font-bold text-gray-700 hover:bg-gray-50 transition-colors border-t border-gray-100">
