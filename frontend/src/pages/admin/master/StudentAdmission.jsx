                  ...
                  <div className="col-span-2 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-100 rounded-xl p-4 flex items-center gap-6 mb-2">
                       <div className="p-1 bg-white rounded-lg shadow-sm border border-blue-100">
                          ...
                          <img 
                              ...
                              alt="Student" 
                              className="h-32 w-24 rounded-md object-cover object-center bg-white border border-gray-200"
                          />
                           ) : (
                               <div className="h-32 w-24 bg-gray-200 rounded-md flex items-center justify-center text-gray-400 text-xs text-center p-2">
                                   No Photo
                               </div>
                           )}
                       </div>
